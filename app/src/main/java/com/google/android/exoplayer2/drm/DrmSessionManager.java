...
public interface DrmSessionManager<T extends ExoMediaCrypto> {
  ...
  DrmSessionManager<ExoMediaCrypto> DUMMY = new DrmSessionManager<ExoMediaCrypto>() {
        ...
        public DrmSession<ExoMediaCrypto> acquireSession(Looper playbackLooper, DrmInitData drmInitData) {
          return new ErrorStateDrmSession<>(new DrmSession.DrmSessionException(new UnsupportedDrmException(UnsupportedDrmException.REASON_UNSUPPORTED_SCHEME)));
        }
