...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
  ...
  public synchronized void addMediaSource(int index, MediaSource mediaSource) {
    addPublicMediaSources( index, Collections.singletonList(mediaSource), /* handler= */ null, /* onCompletionAction= */ null);
  }
  ...
  public synchronized void addMediaSources(Collection<MediaSource> mediaSources) {
    addPublicMediaSources( mediaSourcesPublic.size(), mediaSources, /* handler= */ null, /* onCompletionAction= */ null);
  }
  ...
  public synchronized void removeMediaSourceRange(int fromIndex, int toIndex) {
    removePublicMediaSources( fromIndex, toIndex, /* handler= */ null, /* onCompletionAction= */ null);
  }
  ...
  public synchronized void moveMediaSource(int currentIndex, int newIndex) {
    movePublicMediaSource( currentIndex, newIndex, /* handler= */ null, /* onCompletionAction= */ null);
  }
  ...
  private boolean handleMessage(Message msg) {
    switch (msg.what) {
      case MSG_ADD:
        MessageData<Collection<MediaSourceHolder>> addMessage = (MessageData<Collection<MediaSourceHolder>>) Util.castNonNull(msg.obj);
  ...
  private void updateTimelineAndScheduleOnCompletionActions() {
    ...
    getPlaybackThreadHandlerOnPlaybackThread().obtainMessage(MSG_ON_COMPLETION, onCompletionActions).sendToTarget();
  }
  ...
  static final class MediaSourceHolder {
    ...
    /**
     *代码分析 ConcatenatingMediaSource.addPublicMediaSources->mediaSource=ProgressiveMediaSource； useLazyPreparation=false
     */
