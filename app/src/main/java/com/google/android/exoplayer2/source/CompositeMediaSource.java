...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
  ...
  protected final void prepareChildSource(final T id, MediaSource mediaSource) {
    ...
    MediaSourceCaller caller = (source, timeline) -> onChildSourceInfoRefreshed(id, source, timeline);
  ...
  private static final class MediaSourceAndListener {
    ...
    public MediaSourceAndListener(MediaSource mediaSource, MediaSourceCaller caller, MediaSourceEventListener eventListener) {
