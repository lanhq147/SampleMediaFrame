...
public final class MediaCodecInfo {
   ...
   * @return The created instance.
   */
  public static MediaCodecInfo newInstance(String name, String mimeType, String codecMimeType, CodecCapabilities capabilities,
      boolean hardwareAccelerated, boolean softwareOnly, boolean vendor, boolean forceDisableAdaptive, boolean forceSecure) {
  ...
  private MediaCodecInfo(String name, String mimeType, String codecMimeType, CodecCapabilities capabilities,
      boolean passthrough, boolean hardwareAccelerated, boolean softwareOnly, boolean vendor, boolean forceDisableAdaptive, boolean forceSecure) {
