...
public final class MaskingMediaSource extends CompositeMediaSource<Void> {
   ...
   * new MediaSourceHolder()->MaskingMediaSource(); mediaSource=ProgressiveMediaSource; useLazyPreparation=false
   */
  ...
  public MaskingMediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
    MaskingMediaPeriod mediaPeriod =  new MaskingMediaPeriod(mediaSource, id, allocator, startPositionUs);
    if (isPrepared) {
  ...
  private static final class MaskingTimeline extends ForwardingTimeline {
    ...
    public static MaskingTimeline createWithDummyTimeline(@Nullable Object windowTag) {
      return new MaskingTimeline(new DummyTimeline(windowTag), Window.SINGLE_WINDOW_UID, DUMMY_EXTERNAL_PERIOD_UID);
    }
